...
public class FriendRequestsView extends JFrame {
    private FriendService friendService;
    private JTabbedPane tabbedPane;
    private String currentUserId;
    private UserAccountService userAccountService;
    NavigationHandlerFactory navigationHandlerFactory;

    public FriendRequestsView(FriendService friendService, String currentUserId, UserAccountService userAccountService) {
        ...
        for (FriendRequest friendRequest : friendRequests) {
            ...
            profilePhotoLabel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    navigationHandlerFactory.getNavigationHandler().goToProfileView(userAccountService.getUserById(friendRequest.getSenderId()));
                }
            });
    ...
    private void setupFriendsPanel() {
        ...
        for (UserDTO friend : friends) {
            ...
            profilePhotoLabel.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    navigationHandlerFactory.getNavigationHandler().goToProfileView(friend);
                }
            });
